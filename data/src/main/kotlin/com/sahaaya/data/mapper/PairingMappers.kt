...
fun DocumentSnapshot.toPairing(): Pairing? {
    ...
    return Pairing(
        ...
        patientPhone = getString(PairingFields.PATIENT_PHONE).orEmpty(),
        caregiverPhone = getString(PairingFields.CAREGIVER_PHONE).orEmpty(),
...
fun Pairing.toMap(): Map<String, Any?> = mapOf(
    ...
    PairingFields.PATIENT_PHONE to patientPhone,
    PairingFields.CAREGIVER_PHONE to caregiverPhone,
...
fun DocumentSnapshot.toPairingCode(): PairingCode? {
    ...
    return PairingCode(
        ...
        patientPhone = getString(PairingCodeFields.PATIENT_PHONE).orEmpty(),
...
fun PairingCode.toMap(): Map<String, Any?> = mapOf(
    ...
    PairingCodeFields.PATIENT_PHONE to patientPhone,
